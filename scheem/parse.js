  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_spacedexpression() {
        ...
        if (result0 === null) {
          ...
          if (result0 === null) {
            ...
            if (result0 !== null) {
              result0 = (function(offset, atom) { return atom; })(pos0, result0[1]);
            }
            if (result0 === null) {
              pos = pos0;
            }
            if (result0 === null) {
              ...
              if (result0 !== null) {
                result0 = (function(offset, quote) { return quote; })(pos0, result0[1]);
              }
              if (result0 === null) {
                pos = pos0;
              }
      ...
      function parse_list() {
        ...
        if (result0 !== null) {
          ...
          if (result1 !== null) {
            ...
            if (result2 !== null) {
              ...
              if (result3 !== null) {
                result4 = [];
                result5 = parse_spacedexpression();
                while (result5 !== null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset, first, rest) { rest.unshift(first); return rest; })(pos0, result0[3], result0[4]);
        }
        if (result0 === null) {
          pos = pos0;
        }
